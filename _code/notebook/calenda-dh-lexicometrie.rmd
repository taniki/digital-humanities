...
json_file <- "/home/tk/Dropbox/Projets/2013- digital-humanities/_code/dates_events.json"
...
```{r .width=20, fig.height=10}
library('ggplot2')

keywords.freq.top50 <- keywords.freq[ order( - keywords.freq$Freq ), ][1:50, ]
...
ggplot(keywords.freq.top50, aes(x=Var1, y=Freq)) + geom_bar(stat = "identity") + opts( axis.text.x = theme_text(angle = 90, hjust = 1))
```
